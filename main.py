...
def get_parser():
    ...
    parser.add_argument(
        "--save-interval", type=int, default=1, help="the interval for storing models (#iteration)"
    )
    parser.add_argument(
        "--save-epoch", type=int, default=30, help="the start epoch to save model (#iteration)"
    )
    parser.add_argument(
        "--eval-interval",
        type=int,
    ...
    parser.add_argument(
        "--lr-ratio", type=float, default=0.001, help="decay rate for learning rate"
    )
    parser.add_argument(
...
class Processor:
            ...
            if not arg.train_feeder_args["debug"]:
                ...
                if os.path.isdir(arg.model_saved_name):
                    ...
                    if arg.no_interactive:
                        print("Running in non-interactive mode, keeping existing log_dir")
                    else:
    ...
    def print_time(self):
        ...
        localtime = datetime.now(utc7).strftime("%a %b %d %H:%M:%S %Y")
